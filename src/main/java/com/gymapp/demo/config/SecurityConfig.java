package com.gymapp.demo.config;

import com.gymapp.demo.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfiguration corsConfiguration() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:51967/")); // ✅ Allow all origins for testing (change in
                                                                      // production)
